...
predictions = arima_results.predict(start=start, end=end, dynamic=False, typ="levels").rename(
    "ARIMA (0,2,2) predictions")
...
predictions = sarima_results.predict(start=start, end=end, dynamic=False, typ="levels").rename(
    "SARIMAX (0,2,2)(2,0,2,3) predictions")
